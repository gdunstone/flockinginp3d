...
public class flocking2P3DFinal extends PApplet {
...
class Boid {
  ...
  public void render() {
    ...
    fill (location.x/2.9f,location.y/2.9f,location.z/2.9f,120);
...
public void CheckCameraSinusLevel () {
  // Rotates in "Height"
  camera (
...
public void CheckCameraSinusSpirale () {
...
public void keyPressed() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "flocking2P3DFinal" };
    if (passedArgs != null) {
